        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoleId = table.Column<Guid>(type: "uuid", nullable: false, defaultValue: new Guid("64141029-42fc-41f7-88eb-da0801efa3f3"))
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarNumber = table.Column<string>(type: "character varying(9)", maxLength: 9, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Statements_Statuses_StatusId",
                        column: x => x.StatusId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Statements_StatementId",
                table: "Statements",
                column: "StatementId",
                unique: true);
